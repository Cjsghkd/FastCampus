...
// else if (number1 == 1) println("1입니다!") -> else if 보다 if가 제일 먼저 나와야합니다
...
else println("10, 20, 30, 50 넷다 아닙니다.")

val number2 : Int = 10 + 20 // =을 기준으로 오른쪽에는 값이 오면된다 -> 식이 와도 된다
...
when (number4) {
    in 1..10 -> println("number is in 1..10") // number4 in 1.. 10 -> 결과(Boolean)
