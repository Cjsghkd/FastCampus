...
class InstaMainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tabs.addTab(tabs.newTab().setIcon(R.drawable.btn_insta_home))
        tabs.addTab(tabs.newTab().setIcon(R.drawable.btn_insta_post))
        tabs.addTab(tabs.newTab().setIcon(R.drawable.btn_insta_my))
